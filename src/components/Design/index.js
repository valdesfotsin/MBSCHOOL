...
import pub2 from '../../Images/image1m.jpg';
...
const Design = () => {
  return (
    ...
    <h1 className='text-center ' style={{marginTop: '150px', MarginBottom: '180px', fontFamily: 'Rubik Marker Hatch', color: '#2fa67b' }}>Design </h1>
